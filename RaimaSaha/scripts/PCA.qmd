...
```{r}
# Standardize the data for latitude, longitude, primary_fur_color_num, shift_num, location_num, approaches, indifferent, runs_from, primary_fur_color
temp_data <- clean_data |>
  select(latitude, longitude, primary_fur_color_num, shift_num, location_num, approaches, indifferent, runs_from, primary_fur_color) |>
  drop_na()
scaled_data <- scale(temp_data[, 1:5])
...
Visualizing top two principal components in 2d

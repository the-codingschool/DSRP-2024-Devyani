...
The dataset used for this analysis is from The Squirrel Census, multimedia science prjet dedicated to the Eastern Gray Squirrels in New York (The Squirrel Census Website). The dataset, 2018 Central Park Squirrel Census, contian 3,023 observation and 31 varialbes detailing age, fur color, activity, and behavior of each of the squirrels.
...
In each, I focused on the relationship between

### Principal Component Analysis 

Principal Component Analysis (PCA) is a techniqued used to reduce the dimensionality of a dataset. In other words, it determines which features, or variables, in the dataset account for the most variance and are most important. Considering that there are 31 variables in this dataset

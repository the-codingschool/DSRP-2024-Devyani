...
The dataset used for this analysis is from The Squirrel Census, multimedia science projet dedicated to the Eastern Gray Squirrels in New York (The Squirrel Census Website). The dataset, 2018 Central Park Squirrel Census, contains 3,023 observation and 31 variables detailing age, fur color, activity, and behavior of each of the squirrels.
...
In each, I focused on the relationship between geographical location and human interaction, location and human interaction, shift and human interaction, and primary fur color and human interaction.

Geographical location: This is where the squirrel is found. For parts of the analysis that require numerical data, I used the `latitude` and `longitude` variables to conduct such analysis. However, some parts of the analysis, such as the Chi-Squared Test of Independence, required categorical data, in which case I used the `hectare` variable (manipulated differently than the original provided variable which can be looked at further in my dataCleaning file on GitHub). This variable divides the area of Central park in a grid-like formation and is labeled 01A to 42I.
...
Principal Component Analysis (PCA) is a technique used to reduce the dimensionality of a dataset. In other words, it determines which features, or variables, in the dataset account for the most variance and are most important. Considering that there are 31 variables in this dataset

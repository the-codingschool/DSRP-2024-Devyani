...
The dataset used for this analysis is from The Squirrel Census, multimedia science project dedicated to the Eastern Gray Squirrels in New York (Allen, "2018"). The dataset, 2018 Central Park Squirrel Census, contains 3,023 observation and 31 variables detailing age, fur color, activity, and behavior of each of the squirrels.

...
Figure 4 is a biplot of the PCA. Latitude and longitude appear to be closely correlated. The near 90 degree angle by all variables show that these variables do not appear to be correlated.
